...
<body>
			...
			<div class="col-md-8 slider-wrapper">
				...
				<div class="slideshow-container">
					...
					<div class="mySlides fade">
						<img src="img/Damages01.jpg" style="width:100%">
					</div>

					<div class="mySlides fade">
						<img src="img/Damages02.jpg" style="width:100%">
					</div>

					<div class="mySlides fade">
						<img src="img/Damages03.jpg" style="width:100%">
					</div>
	...
	<div class="container">
		<section class="commercial-lead text-center">
			<div>
				<p>Included in our product suite is our <span>Zero Deposit</span> rental insurance cover. </p>
			</div>
		</section>
...
<hr>
			...
			<div class="row">
				<div class="col-md-6">
					<ul>	
						<li>Guarantee of repair of property damage caused by tenant</li>
						<li>Cover for unpaid utilities</li>
						<li>No conflict with tenant over return of their deposit </li>
					</ul>
				</div>
				<div class="col-md-6">
					<ul>	
						<li>Free tenant vetting </li>
