						...
						<div id="banner">
							...
							<div class="row ">
								...
								<div class="col-md-3 col-md-offset-3 banner-form-wrapper">
									<p class="text-center">Ready to <br>become a chef? <br>
										...
										<form action="form-handler.php" method="POST">
											...
											<label >Choose a Campus*</label><br>
											<select name="campus" id="campus" class="form-control"required><br>
												<!-- <option selected disabled>Choose a Campus</option> -->
												<option value="Durban">Durban</option>
												<!-- <option value="Gauteng">Gauteng</option>
												<option value="JHB - Boksburg">JHB - Boksburg</option>
												<option value="JHB - Sunninghill">JHB - Sunninghill</option>
											...
											Dip. = Diploma | Cert. = Certificate</label><br>
												<select name="course" id="course" class="form-control" required><br>
													<!-- <option selected disabled>Choose a Campus</option> -->
													<option value="" selected disabled="">Select a course</option>
												<option value="Culinary Arts Combination Programme">Culinary Arts Combination Programme</option>
												<option value="Food Preparation & Cooking: Cert">Food Preparation &amp; Cooking: Cert.</option>
												<option value="Food Preparation & Cooking: Dip">Food Preparation &amp; Cooking: Dip.</option>
												<option value="Patisserie: Dip">Patisserie: Dip.</option>
												<option value="I am Unsure">I&apos;m Unsure</option>

													
												</select><br>
												
												<label >City</label><br>
												<input name="city" id="city" class="form-control" ><br>
												<!-- <option selected disabled>Choose a Campus</option> -->

												<label >Suburb</label><br>
												<input name="suburb" id="suburb" class="form-control" ><br>
												<!-- <option selected disabled>Choose a Campus</option> -->
