...
if (empty($fullname) || empty($email) || empty($campus) || empty($course)) {
	header("Location: https://www.capsicumcooking.com/lp-durban-general-enquiry");
    die();
}
...
$to = $admin_email; 
$email_subject = "Durban Landing Page submission: $fullname";
...
header("Location: https://www.capsicumcooking.com/lp-durban-general-enquiry/thank-you.html");
