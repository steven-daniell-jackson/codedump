...
<body>
			...
			<div class="col-md-8 slider-wrapper">
				...
				<div class="slideshow-container">
					...
					<div class="mySlides fade">
						<img src="img/Loss-of-Rental-01.jpg" style="width:100%">
					</div>

					<div class="mySlides fade">
						<img src="img/Loss-of-Rental-02.jpg" style="width:100%">
					</div>

					<div class="mySlides fade">
						<img src="img/Loss-of-Rental-03.jpg" style="width:100%">
					</div>
	...
	<div class="container">
		<section class="commercial-lead text-center">
			<div>
				<p>Included in our product suite is our <span>Comprehensive Cover</span> product, designed to protect our client’s monthly rental income.  </p>
			</div>
		</section>
		...
		<section class="col-md-12 commercial-lease">	
			...
			<div class="row">
				<div class="col-md-6">
					<ul>	
						<li>Your monthly rental guaranteed</li>
						<li>Up to three months in rent cover</li>
						<li>Claims paid out within 48 hours</li>
					</ul>
				</div>
				<div class="col-md-6">
					<ul>	
						<li>No monthly cash flow issues</li>
						<li>Market your property as a zero-deposit rental</li>
					</ul>
				</div>
			</div>
		...
		<section class="col-md-12 commercial-deposit">	
			...
			<div class="text-center row">
				...
				<div class="col-md-12 spacer">
					<img src="img/umbrella.png" class="img-responsive" alt="umbrella">
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-6">
					<ul>	
						<li>Legal fees – up to R50 000</li>
						<li>Damages – up to 1 month’s rent</li>
					</ul>
				</div>
				<div class="col-md-6">
					<ul>	
		...
		<section class="col-md-12 commercial-deposit">	
			...
			<div class="text-center row">
				...
				<div class="col-md-12 spacer">
					<img src="img/choose-us.png" class="img-responsive" alt="choose us">
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-6">
					<ul>	
						<li>Over R 4 500 000-00 paid out in claims last year</li>
						<li>Absconding tenant – up to 1 month’s rent</li>
					</ul>
				</div>
				<div class="col-md-6">
					<ul>	
						<li>We reduce the risk associated with property rentals</li>
						<li>We will vet your tenants to ensure quality</li>
					</ul>
				</div>
			</div>
