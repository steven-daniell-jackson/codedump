...
<div>
	<header class="row thank-you-header">
		<div class="text-left">
		<img src="img/thank-you-header.jpg" alt="Rentshield Logo">
		</div>
		</header>


		<section class="col-md-12 container thank-you">	
			<div class="text-center">
			<h1>Thank you</h1>
			<p>One of our agents will be in touch with you shortly</p>
