...
if (empty($fullname) || empty($email) || empty($campus) || empty($course)) {
	header("Location: https://wwww.capsicumcooking.com/lp-port-elizabeth-general-enquiry");
die();
}
...
header("Location: https://www.capsicumcooking.com/lp-port-elizabeth-general-enquiry/thank-you.html");
