...
if (empty($fullname) || empty($email) || empty($campus) || empty($course)) {
	header("Location: https://wwww.capsicumcooking.com/lp-johannesburg-general-enquiry");
die();
}
...
$mysqli->query("INSERT INTO "
   ...
   '" . $_page_url ."'
	...
	$to = $admin_email; 
	$email_subject = "Johannesburg Landing Page submission: $fullname";
...
header("Location: https://www.capsicumcooking.com/lp-johannesburg-general-enquiry/thank-you.html");
